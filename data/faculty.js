const faculty = [
    ...
    qualification: [
      {
        ...
        year: "2000",
        course: "Chemical Engineering",
        place: "University of Massachusetts, Amherst, USA",
      },
      {
        title: "M.S",
        year: "1995",
        course: "Chemical Engineering",
        place: "University of Rochester, Rochester, USA",
      },
      {
        title: "B.Tech",
        year: "1991",
  ...
  },
  {
    ...
    awards: [
      {
        title:
          "Best Teacher Award, for Excellence in Teaching for the year 2022",
        from: "IIT Madras, India",
      },
      {
        title: "CERN Asia Fellowship, 2005 and CERN Associateship, 2006",
        from: "Visited the theoretical physics group of CERN, Geneva during 2005-2006",
      },
      {
        title: "Alexander von Humboldt Fellowship, 1996",
        from: "Visited the Physikalisches Institut at the University of Bonn in 1997",
      },
      {
        title: "John Stewart Bell Fellowship in Quantum Physics 1995-96",
        from: "Tenable at the Theory Division, CERN, Geneva. (was unable to accept) World Laboratory, Lausanne, Switzerland.",
      },
      {
        title: "Research Fellow, Department of Physics",
        from: "Univ. of Pennsylvania, Philadelphia. 1988 - 1991",
      },
      {
        title: "Dean’s Fellow, Graduate School of Arts and Sciences",
        from: "Univ. of Pennsylvania, Philadelphia. 1987",
      },
      {
    ...
    papers: [
      ...
      // {
      //   title: "The Central Force Problem in n dimensions",
      //   authors: [
      //     "V Balakrishnan, Suresh Govindarajan, S Lakshmibala Resonance",
      //   ],
      //   publisher: "Journal of Science Education",
      //   year: 2021,
      // },
      {
        title: "BKM Lie superalgebras from counting twisted CHL dyons – II",
        authors: ["S. Govindarajan", "S. Samanta"],
        publisher: "Nucl. Phys. B 948",
        year: 2019,
      },
      {
